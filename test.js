...
test.describe('Basic Test Suite', function () {
    ...
    test.it('Basic Test Case', function() {
		...
		element = driver.findElement(webdriver.By.xpath('/html/body/div[1]/div[4]/form/div[2]/div/div[3]/center/input[2]'))
		driver.actions().mouseMove(element).click().perform()	
		driver.get('http://www.paypal.com');
		driver.findElement(webdriver.By.xpath('/html/body/div[1]/footer/div/ul[2]/li[7]/a')).click()
		driver.executeScript('return document.URL').then(function(return_value) {
          assert.equal(return_value, "https://www.paypal.com/us/webapps/mpp/full-sitemap")
		});
		var allLinks=[]
